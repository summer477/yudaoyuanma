...
public interface ErrorCodeConstants {
    ...
    ErrorCode GROUP_NAME_DUPLICATE =new ErrorCode(1_002_030_000,"名字为【{}】的用户组已存在");

    ErrorCode QUICK_SEARCH_NOT_EXISTS = new ErrorCode(1_002_031_000, "快搜热词不存在");
    ErrorCode FLOW_TEMPLATES_NOT_EXISTS = new ErrorCode(1_002_032_000, "流程模板不存在");

    ErrorCode RESEARCH_EVENT_NOT_EXISTS = new ErrorCode(1_002_033_000, "投研活动与会议不存在");

    ErrorCode Event_NAME_DUPLICATE =new ErrorCode(1_002_034_000,"名字为【{}】的投研活动已存在");
    ErrorCode Meeting_NAME_DUPLICATE =new ErrorCode(1_002_035_000,"名字为【{}】的会议名称已存在");
